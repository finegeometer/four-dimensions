...
impl Vertex {
    ...
    pub fn is_inside(&self, poly: &CPolygon) -> bool {
        ...
        let infinity = [
            -100000. - (36.2966109839366), // NOTE: I have modified this to remove the dependency on rand, by replacing those calls with random numbers.
            -100000. - (36.6594125590385), // NOTE: I have modified this to remove the dependency on rand, by replacing those calls with random numbers.
        ];
