/* TXPRBLM: IF USING 1D TEXTURES, USE THIS CODE */
...
//     na::DefaultAllocator: na::allocator::Allocator<f64, <Homogeneous<A> as Space>::Dim, na::U2>,
// {
...
//         na::DefaultAllocator: na::allocator::Allocator<f64, <Homogeneous<B> as Space>::Dim, na::U2>,
...
//     pub fn new([a1, a2, a3]: [f64; 3], [b1, b2, b3]: [f64; 3]) -> Self {
//         Texture {
//             embedding: Linear(na::Matrix4x2::new(
//                 b1 - a1,
//                 a1,
//                 b2 - a2,
//                 a2,
...
//                 1.,
//             )),
//             poly: super::poly::Poly::new(0., 1.),
//         }
//     }
// }

/* TXPRBLM: IF USING 2D TEXTURES, USE THIS CODE */
